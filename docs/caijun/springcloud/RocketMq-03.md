...
![](../../img/java/rocketmq/文件操作和网络操作.png)通过使用mmap的方式，可以省去向用户态的内存复制，提高速度。这种机制在Java中是通过MappedByteBuffer实现的
...
![](../../img/java/rocketmq/同步刷盘和异步刷盘.png)
...
![](../../img/java/rocketmq/RocketMQ角色.jpg)
...
![](../../img/java/rocketmq/消息发送高可用设计.jpg)
...
![](../../img/java/rocketmq/producer负载均衡.png)
...
![](../../img/java/rocketmq/consumer负载均衡.png)

还有另外一种平均的算法是AllocateMessageQueueAveragelyByCircle，也是平均分摊每一条queue，只是以环状轮流分queue的形式，如下图：

![](../../img/java/rocketmq/consumer负载均衡2.png)
...
![](../../img/java/rocketmq/consumer负载均衡3.png)
...
![](../../img/java/rocketmq/死信队列主题.png)

2. 在消息界面根据主题查询死信消息

![](../../img/java/rocketmq/死信队列主题2.png)
...
![](../../img/java/rocketmq/源码6.png)

#### 1）启动NameServer

* 展开namesrv模块，右键NamesrvStartup.java

![](../../img/java/rocketmq/源码3.png)

* 配置**ROCKETMQ_HOME**

![](../../img/java/rocketmq/源码4.png)

![](../../img/java/rocketmq/源码5.png)
...
![](../../img/java/rocketmq/源码7.png)

![](../../img/java/rocketmq/源码8.png)
...
![](../../img/java/rocketmq/NameServer启动流程.png)
...
![](../../img/java/rocketmq/实体数据实例.png)

![](../../img/java/rocketmq/实体数据实例2.png)

#### 2.2.3.2 路由注册

##### 1）发送心跳包

![](../../img/java/rocketmq/路由注册.png)
...
![](../../img/java/rocketmq/NameServer处理路由注册.png)
...
![](../../img/java/rocketmq/NameServer小结.png)

## 2.3 Producer

消息生产者的代码都在client模块中，相对于RocketMQ来讲，消息生产者就是客户端，也是消息的提供者。

![](../../img/java/rocketmq/DefaultMQProducer类图.png)

### 2.3.1 方法和属性

#### 1）主要方法介绍

![](../../img/java/rocketmq/MQAdmin.png)
...
![](../../img/java/rocketmq/MQProducer.png)
...
![](../../img/java/rocketmq/DefaultMQProducer属性.png)
...
![](../../img/java/rocketmq/Topic路由信息.png)
...
![](../../img/java/rocketmq/Broker故障延迟机制核心类.png)
...
![](../../img/java/rocketmq/DefaultMessageStore.png)
...
![](../%E6%96%87%E6%A1%A3/../../img/java/rocketmq/%E5%AD%98%E5%82%A8%E6%96%87%E4%BB%B6.png)
...
![](../../img/java/rocketmq/MappedFileQueue.png)
...
![](../../img/java/rocketmq/MappedFile.png)
...
![](../../img/java/rocketmq/TransientStorePool.png)
...
![](../../img/java/rocketmq/构建消息消费队列和索引文件.png)
...
![](../../img/java/rocketmq/DispatchRequest.png)
...
![](../../img/java/rocketmq/消息分发到消息消费队列.png)
...
![](../../img/java/rocketmq/消息分发到索引文件.png)
...
![](../../img/java/rocketmq/文件恢复总体流程.png)
...
![](../../img/java/rocketmq/GroupCommitRequest.png)
...
![](../../img/java/rocketmq/DefaultMQPushConsumer.png)
...
![](../../img/java/rocketmq/消息消费启动流程.png)
...
![](../../img/java/rocketmq/pullMessageService实现机制.png)
...
![](../../img/java/rocketmq/PullRequest.png)
...
![](../../img/java/rocketmq/ProcessQueue.png)
...
![](../../img/java/rocketmq/消息拉取基本流程.png)
...
![](../../img/java/rocketmq/消息服务端Broker组装消息.png)
...
![](../../img/java/rocketmq/消息拉取客户端处理消息.png)
...
![](../../img/java/rocketmq/PullStatus.png)
...
![](../../img/java/rocketmq/消息拉取流程总结.png)
...
![](../../img/java/rocketmq/ConsumeMessageService.png)
